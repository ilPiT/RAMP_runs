...
LAU_freezer = LAU.Appliance(LAU,1,200,1,1440,0,30,'yes',3)
LAU_freezer.windows([0,1440],[0,0])
LAU_freezer.specific_cycle_1(200,20,5,10)
LAU_freezer.specific_cycle_2(200,15,5,15)
LAU_freezer.specific_cycle_3(200,10,5,20)
LAU_freezer.cycle_behaviour([480,1200],[0,0],[300,479],[0,0],[0,299],[1201,1440])
